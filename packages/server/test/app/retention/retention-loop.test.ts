 ...
 *
 * 휴지통 쪽 인용이 위 블록과 다르다. 보존 기간이 지난 항목의 자동 영구
 * 삭제는 `FR-STORAGE-007`(「휴지통 보존 기간은 기본 30일이고 경과분은 자동
 * 영구 삭제한다」)이고, `FR-STORAGE-006` 은 복구가 편집 권한을 요구한다는
 * 다른 요구다. 위 블록과 이 모듈 머리말의 `FR-STORAGE-006` 은 이 변경보다
 * 앞선 오기이며 여기서 함께 고치지 않는다 — 같은 번호가 `REL-AUDIT-003`
 * 의 VE 에도 실려 있어 SRS 와 한 번에 정정할 일이다.
 *
