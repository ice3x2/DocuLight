...
- [x] Phase 4: index.html 생성 (1시간)
  - [x] Phase 4.1: 현재 index.ejs 복사 및 수정 (30분)
  - [x] Phase 4.2: 불필요한 요소 제거 (30분)
- [x] Phase 5: app.js 수정 (2시간)
  - [x] Phase 5.1: fetchRaw 함수 수정 (30분)
  - [x] Phase 5.2: fetchTree 함수 수정 (30분)
  - [x] Phase 5.3: 검색 함수 수정 (1시간)
- [x] Phase 6: UI 통합 (2시간)
  - [x] Phase 6.1: 다운로드 버튼 UI 추가 (45분)
  - [x] Phase 6.2: 캐싱 로직 추가 (30분)
  - [x] Phase 6.3: 빌드 API에 캐싱 통합 (45분)
  - [x] Phase 6.4: 빌드 버튼 이벤트 핸들러 (45분)
